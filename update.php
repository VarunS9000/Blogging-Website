...
<nav class="navbar navbar-fixed-top navbar-expand-sm navbar-light bg-light border-bottom ">
        ...
        <form action="" class="main-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="content" style = "width:100%;" rows="15" id="content" required><?php echo $content?></textarea>


            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <input type="text" name="description" id="description" value="<?php echo $description?>" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <center>
                <button type="submit" class="btn btn-outline-primary" onclick="updateValidation()" name="insert">Update</button>
                </center>
