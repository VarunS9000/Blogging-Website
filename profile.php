...
<?php
    ...
    if(isset($_GET['delete'])){
      $ide=$_GET['delete'];
      $delete="DELETE FROM blogs WHERE ID=$ide";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right navbg" id="sidebar-wrapper">
            ...
            <button type="submit"  class="btn btn-dark list-group-item list-group-item-action tcol navbg user"><i class="fa fa-home icon_col"></i> Home</button>
             ...
             <form id="logout">
              <li type="none"><button type="submit" class="btn btn-link user tcol navbg" name="logout" onclick="logoutProfile()"><i class="fa fa-user icon_col"></i>Sign Out</button> </li>
            </form>
...
<br>    
            ...
            <div class=" container user_profile">
               <a href="#" class="user_icon"><i class="fa fa-user circle"></i></a> 
                <p class="name"><?php echo $_COOKIE['fullName']?></p>
    ...
    <div class="row mb-5">
      ...
      <img class="img-fluid" src="data:image/jpeg;base64,'.base64_encode($imageval).'"/>
        ...
        <div class="row mb-5">
          ...
          <button type="submit" class="btn btn-light" name="update" value='.$id.' >Edit <i class="fa fa-pencil-square-o"> </i></button>
          </form>

          <!--varunnnnnnnnn idhar delete button daal raha huu -->
          <form id="delete">
          <button type="submit" class="btn btn-light" onclick="deleteBlog()" id="deleteButton" name="delete" value='.$id.'>Delete<i class="fa fa-trash"> </i></button>
          </form>
